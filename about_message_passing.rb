...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # apparently (according to StackOverflow) there was a .send method
    # before they realized that it'd be a good idea to make it .__send__ 
    # to avoid method naming collisions.
  end
